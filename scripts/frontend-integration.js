 ...
 * This file demonstrates how to integrate Vaultforge with a web frontend
 */

// For React/Vue/Angular applications
export class VaultforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VaultforgeClient(provider, contractAddress);
